...
// Partner data directly in the script to avoid import issues
...
function generatePlaceholders() {
  ...
  partnerOfferings.forEach(partner => {
    const partnerDir = path.join(__dirname, '..', 'public', 'images', 'partners', partner.id);
    ...
    partner.products.forEach(product => {
      const filePath = path.join(partnerDir, product.image);
